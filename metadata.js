module.exports = {
  ...
  new: {
    default: [
      ...
      ['src/extend/logic.ts', 'src/extend/logic.ts'],
    ...
    multiModule: [
      ...
      ['tslint.json', 'tslint.json'],
      ['env.d.ts', 'env.d.ts'],
      ['src/extend/context.ts', 'src/common/extend/context.ts'],
      ['src/extend/controller.ts', 'src/common/extend/controller.ts'],
      ['src/extend/logic.ts', 'src/common/extend/logic.ts'],
      ['vercel.json', 'vercel.json'],
      ['vercel.js', 'vercel.js'],
      ['config.js', 'config.js'],
      ['build.mjs', 'build.mjs'],
  ...
  controller: {
    ...
    rest: [
      ...
      [
        ...
        'src/[moduleName]/controller/[action].ts'
      ],
      ['src/logic/index.ts', 'src/[moduleName]/logic/[action].ts']
    ]
  },
